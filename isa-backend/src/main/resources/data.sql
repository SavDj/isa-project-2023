...
VALUES (nextval('user_ids_sequence'), 'user@example.com', 'password', 'John', 'Doe', '1234567890', 1);
...
VALUES (currval('user_ids_sequence'), 'user@example.com', 'password', 'John', 'Doe', '1234567890', 0, 0, 'REGULAR', 'Serbia', 'Novi Sad', 'Doctor', 'General Hospital Info', 1);